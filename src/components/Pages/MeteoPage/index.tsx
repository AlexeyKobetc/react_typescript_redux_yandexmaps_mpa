...
const MeteoPage = ({
  ...
  const countsMeteoCellsOnScreen = (): void => {
    ...
    if (countCells !== getCountMeteoCellsOnScreen) setCountMeteoCellsOnScreen(countCells);
  };
            ...
            <div className="col-12 col-sm-11 mt-5 mb-5">
              <table className="table">
                ...
                <tbody>
                  ...
                  <tr>{renderDescriptionRow(getFiveDayMeteo)}</tr>
                  <tr>{renderTemperatureRow(getFiveDayMeteo)}</tr>
                </tbody>
              </table>
            </div>
          </div>
